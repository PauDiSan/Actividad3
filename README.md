...
- Puedes ver el código fuente de esta apliación [aquí](https://github.com/adiezc10/Actividad3/blob/main/ConversorTemperaturas/src/main/java/ud3/conversortemperaturas/Temperature_converter.java).
#### 4. _Tip Calculator_
Sin modificaciones.
